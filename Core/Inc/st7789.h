...
/* Pin connection*/
#define ST7789_RST_PORT DISP_RES_GPIO_Port
#define ST7789_RST_PIN  DISP_RES_Pin
#define ST7789_DC_PORT  DISP_DATA_GPIO_Port
#define ST7789_DC_PIN   DISP_DATA_Pin
